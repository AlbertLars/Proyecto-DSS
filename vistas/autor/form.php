<div class="d-flex justify-content-center">
    <div class="col-md-4 formulario my-3">
        <form class="form-horizontal" method="POST" action="?c=autor&a=Guardar2">
            <fieldset>
                ...
                <div class="mb-3" style="color:#084594">
                    ...
                    <input type="name" class="form-control" name="ID_Autor" value="<?=$this->modelo->generate_code();?>"
                        readonly>
                </div>
                <div class="form-group">
                    <label style="color:#FFFFFF" class="col-lg-2 control-label mt-2" for="Nombres">Nombres</label>
                    <div class="col-lg-10">
                        <input pattern="^(([a-zA-Záéíóúñ0-9.-]+)[ ]?([a-zA-Záéíóúñ0-9.-]+)?)+$" required
                            class="form-control" name="Nombres" type="text" placeholder="Nombres" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label style="color:#FFFFFF" class="col-lg-2 control-label mt-2" for="Nombre">Apellidos</label>
                    <div class="col-lg-10">
                        <input pattern="^(([a-zA-Záéíóúñ0-9.-]+)[ ]?([a-zA-Záéíóúñ0-9.-]+)?)+$" required
                            class="form-control" name="Apellidos" type="text" placeholder="Apellidos" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label style="color:#FFFFFF" class="col-lg-2 control-label mt-2" for="Nombre">Nacionalidad</label>
                    <div class="col-lg-10">
                        <input pattern="^(([a-zA-Záéíóúñ0-9.-]+)[ ]?([a-zA-Záéíóúñ0-9.-]+)?)+$" required
                            class="form-control" name="Nacionalidad" type="text" placeholder="Nacionalidad" value="">
                    </div>
