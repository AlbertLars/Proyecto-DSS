<div class="d-flex justify-content-center">
    <div class="col-md-4 formulario my-3">
        <form class="form-horizontal" method="POST" action="?c=categoria&a=Guardar2">
            <fieldset>
                <legend style="color:#000" class="text-center"><?=$titulo?> Categorias</legend>
                ...
                <div class="mb-3" style="color:#084594">
                    ...
                    <input type="name" class="form-control" name="ID_Categoria"
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input pattern="^(([a-zA-Záéíóúñ0-9.-]+)[ ]?([a-zA-Záéíóúñ0-9.-]+)?)+$" required
                            class="form-control" name="Nombre_Categoria" type="text" placeholder="Nombre Producto"
                            value="<?=$p->getPro_nom()?>">
                    </div>
